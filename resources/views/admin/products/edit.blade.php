                    ...
                    <div class="card-body">
                        ...
                        >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="@if(isset($product)){{ $product->name}} @endif" autofocus>                      @error('name')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="sale" type="text" class="form-control @error('sale') is-invalid @enderror" name="sale" value="@if(isset($product)){{ $product->sale}} @endif" autofocus>
                                    @error('sale')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
